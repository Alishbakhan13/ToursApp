    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            console.log('here'); //  location.reload(true); // fresh  request  to server
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"maps.js":[function(require,module,exports) {
"use strict";
...
/* eslint-disable */
var displayLocation = function displayLocation(tours) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYWxpc2hiYTEzIiwiYSI6ImNrMnB6eGdmajA5MXYzam55NHh2cHF4Zm0ifQ.-ADsLJ3imReXWEhdyDth1g';
  ...
  tours.forEach(function (loc) {
    //Creating marker
    var div = document.createElement('div');
    div.className = 'marker'; //adding  marker to  map
  ...
  return regeneratorRuntime.async(function updateData$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          console.log('hh');
          URL = type === 'password' ? '/api/v1/users/updatecurrentpassword' : '/api/v1/users/updateuser';
          console.log(URL);
          console.log(email);
          _context.prev = 4;
          _context.next = 7;
...
/*eslint-disable*/
var stripe = Stripe('pk_test_nUmMF6MiiXahZkLI5lScMLr500OLWNlBuS');

var payment = function payment(tourId) {
  var response;
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return regeneratorRuntime.awrap((0, _axios.default)("/api/v1/booking/checkout_session/".concat(tourId)));
        ...
        case 3:
          ...
          return regeneratorRuntime.awrap(stripe.redirectToCheckout({
            sessionId: response.data.message.session.id
          }));
...
var loginControl = document.querySelector('.form-login');
...
var bookingbtn = document.getElementById('tourbooking'); // if loaded

if (maps) {
  var toursLocation = JSON.parse(maps.dataset.location);
  (0, _maps.displayLocation)(toursLocation);
}

if (loginControl) {
  loginControl.addEventListener('submit', function (event) {
...
if (updateForm) {
  updateForm.addEventListener('submit', function (event) {
    ...
    (0, _updateUser.updateData)(form, 'User Data');
  });
}

if (updatePassword) {
  updatePassword.addEventListener('submit', function _callee(event) {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 7;
            return regeneratorRuntime.awrap((0, _updateUser.updateData)({
